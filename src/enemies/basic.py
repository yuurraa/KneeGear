...
class BasicEnemy(BaseEnemy):
    def __init__(self, x, y, scaling):
        ...
        # Randomized initial delay for homing shot (scaled)
        ...
        # Randomized initial delay for AOE shot (scaled)
        ...
        # Apply scaling to attributes
        self.score_reward = math.floor(constants.base_basic_enemy_xp_reward * self.scaling)
        self.speed = constants.basic_enemy_speed * game_state.scale
        self.outline_size = constants.REGULAR_ENEMY_OUTLINE_SIZE * game_state.scale
        self.inner_size = constants.REGULAR_ENEMY_INNER_SIZE * game_state.scale
    ...
    def shoot(self, target_x, target_y, game_state):
        """Handles enemy shooting logic, scaling bullet intervals properly."""
