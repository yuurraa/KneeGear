    ...
    def __init__(self):
        ...
        self.upgrades = [
            ...
            Upgrade(
                ...
                description="Adds 25% to 30s damage boost from pickups",
                Rarity="Common",
                apply=lambda player: setattr(player, 'hp_pickup_damage_boost_percent_bonus', player.hp_pickup_damage_boost_percent_bonus + 25),
                icon="dmg_pickup",
                max_level=4,
            ),
            Upgrade(
            ...
            Upgrade(
                ...
                description="Pickups now permanently increase damage by 2%",
                Rarity="Epic",
                apply=lambda player: setattr(player, 'hp_pickup_permanent_damage_boost_percent_bonus', player.hp_pickup_permanent_damage_boost_percent_bonus + 2),
                icon="permanent_dmg",
                max_level=1,
            ),
            Upgrade(
                name="Pickup Permanent HP Boost",
                description="Pickups now permanently increase max hp by 2%",
                Rarity="Epic",
                apply=lambda player: setattr(player, 'hp_pickup_permanent_hp_boost_percent_bonus', player.hp_pickup_permanent_hp_boost_percent_bonus + 2),
                icon="permanent_hp",
                max_level=1,
            ),
            Upgrade(
